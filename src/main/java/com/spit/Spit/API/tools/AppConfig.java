...
public class AppConfig {
    ...
    public void setup(){
        ...
        Post cooking = new Post(new Date(1234030615354L), user1, "Just tried a new recipe for garlic butter shrimp, and it turned out amazing! Who else loves experimenting in the kitchen?");
        ...
        Post fitness = new Post(new Date(1234030615354L), user3, "Hit a new personal record in deadlifts today! Feeling strong and motivated. What's your favorite workout to stay fit?");
        ...
        Post tech = new Post(new Date(1234030615354L), user4, "Just got my hands on the latest smartphone. The camera quality is mind-blowing! Anyone else excited about new tech releases?");
        ...
        Post travel = new Post(new Date(1234030615354L), user5, "Just returned from a backpacking trip in Europe. The landscapes were breathtaking. What's your dream travel destination?");
        ...
        Post movie = new Post(new Date(1234030615354L), user2, "Just watched Inception. The plot twists had me on the edge of my seat! What's the last movie that blew your mind?");
